...
export const routes = [
	{
		...
		Icon: <WorkIcon color="primary" fontSize="small" style={{ display: 'inline-flex' }} />,
	},
	{
		route: '/#projects',
		displayName: 'Projects',
		Icon: <ListIcon color="primary" fontSize="small" style={{ display: 'inline-flex' }} />,
	},
	{
		route: '/#contact',
		displayName: 'Contact',
		Icon: <ContactsIcon color="primary" fontSize="small" style={{ display: 'inline-flex' }} />,
	},
];
...
export const experiences = [
	...
	},
	{
		...
		description: [
			'Assisted peers and lower classmates with various studying techniques for exams, project, and/or assignments.',
...
export const featuredProjects = [
	{
		...
		description: [
			...
			'Create or import recipes that is shared with other users.',
			'Make "Creations" which are byproducts of the recipes from the website.',
			'Auth Server is isolated from this specific app to be utilized for future side projects as well as to allow for upgrades to be done seperately(Less headche).',
	...
	},
	{
		...
		description: [
			'Handles future and current side projects.',
	...
	},
	{
		...
		description: [
			...
			"NodeJS(express) with it's asynchronouse features powers the backend.",
